<?php
    ...
    $edit_kh = $db->fetchID("khachhang","ma_kh",$ma_kh);
    if (empty($edit_kh)) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
    	...
    	if (empty($error)) {
    		$updata1 = $db->update("khachhang",$data,array("ma_kh"=>$ma_kh));
    		// print_r($insert);
    		if ($updata1 > 0) {
          ...
          <div class="card-body">
		    ...
		    <form class="form-horizontal" action="" method="POST">
		        <div class="form-group">
		            ...
		            <div class="col-sm-10">
		                <input type="text" class="form-control " value="<?php echo $edit_kh['ma_kh'] ?>" id="disabledInput" placeholder="Nhập mã khách hàng" disabled>
		            </div>
		        </div>
		        <div class="form-group">
		            <label class="control-label col-sm-2" for="pwd">Tài khoản:</label>
		            <div class="col-sm-10">
		            	<input type="text" class="form-control" value="<?php echo $edit_kh['taikhoan'] ?>" name="taikhoan" placeholder="Nhập tài khoản">
		        ...
		        <div class="form-group">
		            ...
		            <div class="col-sm-10">
		                <input type="text" class="form-control" value="<?php echo $edit_kh['matkhau'] ?>" name="matkhau" placeholder="Nhập mật khẩu">
		        ...
		        <div class="form-group">
		            ...
		            <div class="col-sm-10">
		                <input type="text" class="form-control" value="<?php echo $edit_kh['tenkh'] ?>" name="tenkh" placeholder="Nhập tên khách hàng">
		        ...
		        <div class="form-group">
		            ...
		            <div class="col-sm-10">
		                <input type="text" class="form-control" value="<?php echo $edit_kh['email'] ?>" name="email" placeholder="Nhập email">
		        ...
		        <div class="form-group">
		            ...
		            <div class="col-sm-10">
		                <input type="text" class="form-control" value="<?php echo $edit_kh['sodienthoai'] ?>" name="sodienthoai" placeholder="Nhập số điện thoại">
		        ...
		        <div class="form-group">
		            ...
		            <div class="col-sm-10">
		                <input type="text" class="form-control" value="<?php echo $edit_kh['diachi'] ?>" name="diachi" placeholder="Nhập địa chỉ">
